...
extern "C" XPCF_MODULEHOOKS_API xpcf::XPCFErrorCode XPCF_getComponent(const xpcf::uuids::uuid& componentUUID,SRef<xpcf::IComponentIntrospect>& interfaceRef)
{
    ...
    errCode = xpcf::tryCreateComponent<SolAR::MODULES::SolARModuleColmap::StructureFromMotion>(componentUUID,interfaceRef);
    //if (errCode != xpcf::XPCFErrorCode::_SUCCESS) {
      //  errCode = xpcf::tryCreateComponent<SolAR::MODULES::SolARModuleColmap::MultiViewStereo>(componentUUID,interfaceRef);
    //}
    return errCode;
}
...
XPCF_ADD_COMPONENT(SolAR::MODULES::SolARModuleColmap::StructureFromMotion)
//XPCF_ADD_COMPONENT(SolAR::MODULES::SolARModuleColmap::MultiViewStereo)
